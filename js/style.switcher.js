jQuery(function($) {
	var styleSwitcher = {
		...
		initialize : function() {
			...
			// Style Switcher CSS
			$("head").append($('<link rel="stylesheet">').attr("href", "wp-content/themes/theme_2/css/font-awesome.css"));
			$("head").append($('<link rel="stylesheet">').attr("href", "wp-content/themes/theme_2/css/theme_panel.css"));
			$("head").append($('<link rel="stylesheet">').attr("href", "http://code.jquery.com/ui/1.11.1/themes/smoothness/jquery-ui.css"));
			$("head").append($('<link rel="stylesheet/less">').attr("href", "wp-content/themes/theme_2/css/skin.less"));
			$("head").append($('<script />').attr("src", "http://code.jquery.com/ui/1.11.1/jquery-ui.js"));

			$.getScript("wp-content/themes/theme_2/js/less.js", function(data, textStatus, jqxhr) {
				$.getScript('wp-content/themes/theme_2/js/jquery.easing.js', function(data, textStatus, jqxhr) {
					$("body").append('<div id="theme_panel"></div> <div id="all-headers" />');
					$("#theme_panel").load("wp-content/themes/theme_2/switcher.html", function(response, status, xhr) {
						if (status == "success") {
							$this.build();
							$this.events();
		...
		events : function() {
			...
			headerStyle = function(headername, ind) {
				...
				$("#all-headers").load("wp-content/themes/theme_2/css/header-styles.html", function(responseTxt, statusTxt, xhr) {
